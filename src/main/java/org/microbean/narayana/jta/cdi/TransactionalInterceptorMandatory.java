...
final class TransactionalInterceptorMandatory extends TransactionalInterceptorBase {

  private static final long serialVersionUID = 1L;

  @Inject
  TransactionalInterceptorMandatory(final TransactionManager transactionManager) {
  ...
  protected final Object doIntercept(final TransactionManager transactionManager,
    ...
    return this.invokeInCallerTx(invocationContext, transaction);
  }
